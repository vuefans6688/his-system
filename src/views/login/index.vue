  ...
  <div class="login-container">
    <el-form class="login-form" ref="loginForm" :model="loginForm" :rules="loginRules" auto-complete="on" label-position="left">
      ...
      <div class="control">
        ...
        <el-button type="primary" class="register" @click.native.prevent="handleRegister">注册</el-button>
        <el-button type="primary" class="forget" @click.native.prevent="handleForget">忘记密码</el-button>
      </div>
    </el-form>
  </div>
</template>
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          this.$store.dispatch('user/login', this.loginForm).then(() => {
            this.$router.push({ path: '/admin' || this.redirect })
            this.loading = false
          }).catch(() => {
            this.loading = false
          })
